...
const updateSchema = z.object({
  ...
  work_zip: z.string().max(10).nullable().optional(),
  work_city: z.string().max(120).nullable().optional(),
  work_lat: z.number().nullable().optional(),
  work_lon: z.number().nullable().optional(),
